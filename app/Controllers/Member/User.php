...
class User extends BaseController
{
    ...
    public function attendanceProcess()
    {
        ...
        if (empty($fotoAbsen)) {
            ...
            $absensi->save($updateData);
            notif_swal('success', 'Berhasil Absen');
            return redirect()->back();
        }
    }
    ...
    public function history()
    {
        ...
        return view('member/v_history', $data);
    }
    public function setting()
    {
        ...
        return view('member/v_setting', $data);
    }
