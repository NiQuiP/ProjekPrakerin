                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="">
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                name="username" value="<?php if ($session->getFlashdata('username'))
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="<?= site_url('user/lupapassword')?>">Forgot Password?</a>
                                                <input type="submit" name="submit" class="btn btn-primary" value="LOGIN">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="<?= base_url('/registrasi')?>">Belum punya akun? Registrasi!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
