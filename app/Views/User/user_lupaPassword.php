                                    ...
                                    <form method="POST" action="">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputEmail" type="text"
                                                placeholder="name@example.com" name="username" value="<?php if ($session->getFlashdata('username'))
                                                    echo $session->getFlashdata('username') ?>" />
                                                <label for="inputEmail">Email address / Username</label>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="<?= site_url('admin/login') ?>">Return to login</a>
                                            <input type="submit" name="submit" class="btn btn-primary"
                                                value="Kirim Email Recovery">
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="<?= base_url('/registrasi') ?>">Need an account? Sign
                                            up!</a>
                                    </div>
                                </div>
                            </div>
