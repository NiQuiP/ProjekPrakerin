                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputUsername" type="text"
                                                placeholder="Enter your first name" name="username" value="<?php if ($session->getFlashdata('username'))
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="email"
                                                    placeholder="name@example.com" name="email" value="<?php if ($session->getFlashdata('email'))
